...
func (r *Pool) Cycle(ctx context.Context, opts pubsub.CycleOptions) error {
...
func (r *Pool) CycleIter(ctx context.Context, opts pubsub.CycleOptions) iter.Seq2[pubsub.Processor, error] {
